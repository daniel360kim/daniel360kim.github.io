// Vendored from antimatter15/splat (MIT License, Copyright (c) 2023 Kevin Kwok)
// https://github.com/antimatter15/splat — minor modifications: local data URL, carousel off, scene camera
let cameras = [
    {
        id: 0,
        img_name: "00001",
...
let defaultViewMatrix = [
    1, 0, 0, 0, 0, -0.0905, 0.9959, 0, 0, -0.9959, -0.0905, 0, 4.0,
    6.6996, 58.8482, 1,
];
...
async function main() {
    ...
    const url = new URL(
        params.get("url") || "urban_construction.splat",
        location.href,
    );
